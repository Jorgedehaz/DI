...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/iconoInmo.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.gridLayout_2.addWidget(self.txtNomcli, 1, 5, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.cmbMunicli, 3, 7, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.cmbProvcli, 3, 5, 1, 1)
        self.lblMunicli = QtWidgets.QLabel(parent=self.pesClientes)
        self.lblMunicli.setObjectName("lblMunicli")
        self.gridLayout_2.addWidget(self.lblMunicli, 3, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.chkHistoriacli, 1, 8, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.txtMovilcli, 2, 5, 1, 1)
